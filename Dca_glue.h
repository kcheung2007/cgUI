...
VOID GreyMenu (int);
TW_UINT16 CallDSMEntry(pTW_IDENTITY, pTW_IDENTITY, TW_UINT32,	TW_UINT16, TW_UINT16, TW_MEMREF);
//TW_UINT32 CallDSMEntry(pTW_IDENTITY, pTW_IDENTITY, TW_UINT32,	TW_UINT32, TW_UINT32, TW_MEMREF);
